    ...
    <div>
      ...
      {invoices === null ? (
        ...
        <div className="tblwrap">
          <table className="dt">
            <thead><tr><th>Invoice</th><th>Dealer</th><th>Cartons</th><th>Total ₹</th><th>Status</th><th>PI ref</th><th>Booked by</th><th>Date</th></tr></thead>
            <tbody>
              {invoices.map((i) => (
                <tr key={i.no}>
              ...
              {!invoices.length && <tr><td colSpan={8}><div className="empty">No invoices match</div></td></tr>}
            </tbody>
          </table>
        </div>
      )}
